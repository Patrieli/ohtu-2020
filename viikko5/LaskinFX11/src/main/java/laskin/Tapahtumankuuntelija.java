...
public class Tapahtumankuuntelija implements EventHandler {
    ...
    private final HashMap<Button, Komento> komennot;
    private Komento edellinen = null;
 
    public Tapahtumankuuntelija(final TextField tuloskentta, final TextField syotekentta, final Button plus, final Button miinus, final Button nollaa, final Button undo) {
        this.undo = undo;
